...
def merge_rank_summary_files(
    lowfile, highfile, outfile, args, lowfile_prefix="", highfile_prefix=""
):
    """
        ...
        for gp in groupidstr:
            if gp not in ids:
                logging.error(
                    "Sample label "
                    + gp
                    + " does not match records in your count table."
                )
